...
class SomeModel < ActiveRecord::Base
  def method_with_dot_notation
    # bad
    SomeModel.includes(includes).where(some_attribute: "value").order(:some_attribute)

    # good
    SomeModel.includes(includes).
      where(some_attribute: "value").
